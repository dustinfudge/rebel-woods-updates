...
function ProfessionalContact({ allowText = false, name, phone, title }: { readonly allowText?: boolean; readonly name: string; readonly phone: string; readonly title: "Veterinarian" | "Farrier" }): React.JSX.Element {
